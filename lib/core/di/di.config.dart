...
import '../../presentation/authentication/ui/cubit/authentication/auth_view_model.dart'
    as _i212;
import '../../presentation/chatbot/data/data source/server/impl/chatbot_data_source_impl.dart';
...
import '../../presentation/home/domain/Use%20Case/home_trips_use_case.dart'
    as _i241;
import '../../presentation/home/ui/cubit/category/category_view_model.dart'
    as _i460;
import '../../presentation/home/ui/cubit/most%20popular/most_popular_view_model.dart'
    as _i221;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.factory<_i623.ChatbotDataSource>(
      () => ChatbotDataSourceImpl(apiManager: gh<_i949.ApiManager>()),
    );
    ...
    gh.factory<_i460.CategoryViewModel>(
      () =>
          _i460.CategoryViewModel(categoryUseCase: gh<_i712.CategoryUseCase>()),
    );
    gh.factory<_i221.MostPopularViewModel>(
      () => _i221.MostPopularViewModel(
